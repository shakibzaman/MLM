...
<div class="card text-bg-theme">
    ...
    <div class="card-header d-flex justify-content-between align-items-center p-3">
        <h4 class="m-0">{{ $type }} Reward List</h4>
    </div>
</div>
<div class="row">
    <div class="col-md-12">
        <!-- About User -->
        @if($rewards_list->count()>0)
            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $list->reward_mapping->rewardSite->name }}</td>
                        <td>{{ $list->reward_mapping->rewardSubmitType->name }}</td>
                        ...
                        <td>
                            <a class="btn-primary p-2 rounded text-white cursor-pointer" data-bs-toggle="modal"
                                ...
                                data-attr="{{ route('extraReward_show',$list->id) }}" title="View Review"> View
                            </a>
                        </td>
                    </tr>
                    @endforeach
