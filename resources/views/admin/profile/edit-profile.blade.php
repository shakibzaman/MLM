    ...
    <div class="col-md-12">
        <div class="nav-align-top">
            <ul class="nav nav-pills flex-column flex-sm-row mb-6 gap-2 gap-lg-0">
                ...
                <li class="nav-item"><a class="nav-link active" href="{{ route('profile.edit') }}"><i
...
<form id="editForm" action="{{ route('profile.update') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="card-body">
                            ...
                            <div class="col-lg-10 col-xl-9 border">
                                <div class="mb-3 position-relative">
                                    <input class="form-control{{ $errors->has('avatar') ? ' is-invalid' : '' }}"
                                        type="file" name="avatar" id="image_input" style="display: none;"
                                        accept="image/*">
                    ...
                    <ul class="list-unstyled my-3 py-1">
                        <div class="mb-3 row">
                            ...
                            <div class="col-lg-10 col-xl-9 border">
                                <div class="mb-3 position-relative">
                                    <input class="form-control{{ $errors->has('cover_image') ? ' is-invalid' : '' }}"
                                        type="file" name="cover_image" id="cover_image_input" style="display: none;"
                                        accept="image/*">
                                    @if (isset($userData->cover_image) && !empty($userData->cover_image))
                                    <div class="position-relative">
                                        <img src="{{ asset('storage/' . $userData->cover_image) }}" alt="Member Profile"
                                            class="img-fluid" style="max-width: 200px; cursor: pointer;"
                                    ...
                                    @endif
                                    {!! $errors->first('cover_image', '<div class="invalid-feedback">:message
                                    </div>') !!}
                                </div>
                            </div>
                        </div>
