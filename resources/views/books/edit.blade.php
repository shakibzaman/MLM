...
@section('content')
    ...
    <div class="card text-bg-theme">
         ...
         <div class="card-header d-flex justify-content-between align-items-center p-3">
            <h4 class="m-0">{{ !empty($title) ? $title : 'Book' }}</h4>
            <div>
        ...
        <div class="card-body">
            ...
            <form method="POST" class="needs-validation" novalidate action="{{ route('books.book.update', $book->id) }}" id="edit_book_form" name="edit_book_form" accept-charset="UTF-8"  enctype="multipart/form-data">
            {{ csrf_field() }}
