...
<head>
  ...
  <meta name="google-site-verification"
    content="{{ config('variables.googleSiteVerification') ? config('variables.googleSiteVerification') : '' }}">

  @if(config('variables.google_analytics_id'))
  <!-- Google Analytics -->
  <script async src="https://www.googletagmanager.com/gtag/js?id={{ config('variables.google_analytics_id') }}">
  </script>
  <script>
    window.dataLayer = window.dataLayer || [];
            ...
            gtag('config', '{{ config('variables.google_analytics_id') }}');
  </script>
