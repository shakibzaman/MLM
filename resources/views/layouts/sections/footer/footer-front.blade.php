      ...
      <div class="row gx-0 gy-6 g-lg-10">
        <div class="col-lg-5">
          <a href="javascript:;" class="app-brand-link mb-6">
            <span class="app-brand-logo demo"><img src="{{ asset('storage/' . $globalSetting->site_logo) }}" alt=""
                class="admin-logo" style="width: 100%"></span>
            <span class="app-brand-text demo footer-link fw-bold ms-2 ps-1">{{ $globalSettings->site_title ?? 'Site
              Title'
              }}</span>
          </a>
          {{-- <p class="footer-text footer-logo-description mb-6">
            ok Most developer friendly & highly customisable Admin Dashboard Template.
          </p> --}}
