{{-- <div class="mb-3 row">
    <label for="site_logo" class="col-form-label text-lg-end col-lg-2 col-xl-3">Site Logo</label>
    <div class="col-lg-10 col-xl-9 border">
        <div class="mb-3 position-relative">
            <input class="form-control{{ $errors->has('site_logo') ? ' is-invalid' : '' }}" type="file" name="site_logo"
                id="site_logo_input" style="display: none;">
            @if (isset($globalSetting->site_logo) && !empty($globalSetting->site_logo))
            <div class="position-relative">
                <img src="{{ asset('storage/' . $globalSetting->site_logo) }}" alt="Site Logo" class="img-fluid"
                    style="max-width: 200px; cursor: pointer;" id="site_logo_preview">
                <div class="overlay-text">Upload Logo Here</div>
            </div>
            @endif
    ...
    <div class="col-lg-10 col-xl-9 border">
        <div class="mb-3 position-relative">
            <input class="form-control{{ $errors->has('site_fevicon') ? ' is-invalid' : '' }}" type="file"
                name="site_fevicon" id="site_fevicon_input" style="display: none;">
            @if (isset($globalSetting->site_fevicon) && !empty($globalSetting->site_fevicon))
            <div class="position-relative">
                <img src="{{ asset('storage/' . $globalSetting->site_fevicon) }}" alt="Site Fevicon" class="img-fluid"
                    style="max-width: 200px; cursor: pointer;" id="site_fevicon_preview">
                <div class="overlay-text">Upload Fevicon Here</div>
            </div>
            @endif
    ...
    <div class="col-lg-10 col-xl-9 border">
        <div class="mb-3 position-relative">
            <input class="form-control{{ $errors->has('admin_login_cover') ? ' is-invalid' : '' }}" type="file"
                name="admin_login_cover" id="admin_login_cover_input" style="display: none;">
            @if (isset($globalSetting->admin_login_cover) && !empty($globalSetting->admin_login_cover))
            <div class="position-relative">
                <img src="{{ asset('storage/' . $globalSetting->admin_login_cover) }}" alt="Site Fevicon"
                    class="img-fluid" style="max-width: 200px; cursor: pointer;" id="admin_login_cover_preview">
                <div class="overlay-text">Admin Login Cover</div>
            </div>
            @endif
...
<div class="mb-3 row">
    ...
    <div class="col-lg-10 col-xl-9 border">
        <div class="mb-3 position-relative">
            <input class="form-control{{ $errors->has('site_logo') ? ' is-invalid' : '' }}" type="file" name="site_logo"
                id="site_logo_input" style="display: none;" accept="image/*">
            @if (isset($globalSetting->site_logo) && !empty($globalSetting->site_logo))
            <div class="position-relative">
                <img src="{{ asset('storage/' . $globalSetting->site_logo) }}" alt="Site Logo" class="img-fluid"
                    style="max-width: 200px; cursor: pointer;" id="site_logo_preview">
...
<div class="mb-3 row">
    ...
    <div class="col-lg-10 col-xl-9 border">
        <div class="mb-3 position-relative">
            <input class="form-control{{ $errors->has('site_fevicon') ? ' is-invalid' : '' }}" type="file"
                name="site_fevicon" id="site_fevicon_input" style="display: none;" accept="image/*">
            @if (isset($globalSetting->site_fevicon) && !empty($globalSetting->site_fevicon))
            <div class="position-relative">
                <img src="{{ asset('storage/' . $globalSetting->site_fevicon) }}" alt="Site Fevicon" class="img-fluid"
                    style="max-width: 200px; cursor: pointer;" id="site_fevicon_preview">
...
<div class="mb-3 row">
    ...
    <div class="col-lg-10 col-xl-9 border">
        <div class="mb-3 position-relative">
            <input class="form-control{{ $errors->has('admin_login_cover') ? ' is-invalid' : '' }}" type="file"
                name="admin_login_cover" id="admin_login_cover_input" style="display: none;" accept="image/*">
            @if (isset($globalSetting->admin_login_cover) && !empty($globalSetting->admin_login_cover))
            <div class="position-relative">
                <img src="{{ asset('storage/' . $globalSetting->admin_login_cover) }}" alt="Admin Login Cover"
                    class="img-fluid" style="max-width: 200px; cursor: pointer;" id="admin_login_cover_preview">
                <div class="overlay-text">Admin Login Cover</div>
            </div>
            @endif
...
<div class="mb-3 row">
    ...
    <div class="col-lg-10 col-xl-9">
        <select class="select2 form-control form-select{{ $errors->has('site_currency_type') ? ' is-invalid' : '' }}"
...
<div class="mb-3 row">
    ...
    <div class="col-lg-10 col-xl-9">
        <select class="select2 form-control form-select{{ $errors->has('site_currency') ? ' is-invalid' : '' }}"
...
<div class="mb-3 row">
    ...
    <div class="col-lg-10 col-xl-9">
        <select class="select2 form-control form-select{{ $errors->has('referral_type') ? ' is-invalid' : '' }}"
...
<div class="mb-3 row">
    ...
    <div class="col-lg-10 col-xl-9">
        <select class="select2 form-control form-select{{ $errors->has('home_redirect') ? ' is-invalid' : '' }}"
